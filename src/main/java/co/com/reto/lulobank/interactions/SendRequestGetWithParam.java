...
public class SendRequestGetWithParam extends SendRequestGet implements Interaction {
    HelpFunctions helpFunctions = new HelpFunctions();

    private final String param;
    public SendRequestGetWithParam(String endpoint, String service, String param) {
...
try {
    ...
    public static SendRequestGetWithParam toService (String endpoint, String service, String param){
        return Tasks.instrumented(SendRequestGetWithParam.class, endpoint, service, param);
    }
}
